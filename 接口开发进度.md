...
|-----|----------|------|------|-----|
|1| [按条件查询拍卖会列表](首页/拍卖会信息相关接口.md) |开发中| [测试](http://demo.shbgz.com/APP/app_auctionInfoBase.aspx?m=getAuctionMainList&status=%E9%A2%84%E5%B1%95%E4%B8%AD&number=0)|不分页|
...
|Index| 接口名称 | 状态 | 接口 | Information |
|-----|-----|------|------|-----|
|31| [我的拍卖会](我/我的拍卖会管理.md) |开发中| [测试](http://demo.shbgz.com/APP/app_accountSystemSettings.aspx?sessionid=3jjmhb510yej30q2krechln3&m=getMyAuctionMainList&status=&number=1)|{"code":-1,"data":null}|
|32| [正在竞价](我/正在竞价管理.md) |开发中|[测试](http://demo.shbgz.com/APP/app_accountSystemSettings.aspx?sessionid=3jjmhb510yej30q2krechln3&m=getBiddingLotList) |{"code":-1,"data":null}|
|33| [获取用户收藏的拍品列表](我/我的收藏.md) |开发中| [测试](http://demo.shbgz.com/APP/app_accountSystemSettings.aspx?sessionid=3jjmhb510yej30q2krechln3&m=getCollectedAuctionList&mainState=&status=&number=1)|{"code":-1,"data":null}|
...
|Index| 接口名称 | 状态 | 接口 | Information |
|-----|-----|------|------|-----|
|44|[我的拍品列表](我/结算交割.md#2)|开发中| [测试]( http://demo.shbgz.com/APP/app_settlementDelivery.aspx?sessionid=3jjmhb510yej30q2krechln3&m=getMyAuctionList)| {"code":1,"data":null}|
